...
public class TowerTypes {
	...
	public static TowerInfoComponent CarTower = new TowerInfoComponent("Car", "This is a six-four", "/Images/BlankCannon.png",50,100,10,10,0,0,83,83,ProjectileTypes.PirateArcher);
